<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_AJAXSMARTY_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module implements AJAX in Smarty <br> <br>
    </p>
    ...
    <p class="even">
        There is no tutorial, but you can read the original article by Andrei Cioroianu: <a href="http://www.ibm.com/developerworks/library/wa-aj-smarty/" target="_blank">Ajax and Smarty, Part 1: Develop Ajax applications with Smarty</a>.
        <br><br>
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/mambax7/ajaxsmartyibm" target="_blank">GitHub</a><br><br>
